...
router.post('/sendData', (request, response) => {
    ...
    var sql = `INSERT INTO medidas (idMedidas,umidade, temperatura_dht11, luminosidade, temperatura_lm35) VALUES (null, ${umidade}, ${temperatura_dht11}, ${luminosidade}, ${temperatura_lm35})`;
