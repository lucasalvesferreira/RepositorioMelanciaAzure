...
router.post('/sendData', (request, response) => {
  ...
  // Para servidor azure (nuvem)

  `INSERT INTO medidas (umidade, temperatura_lm35,hr_medida,fkCanteiro) VALUES (${umidade}, ${temperatura_lm35},GETDATE(), ${((Math.random()*3)+1).toFixed()})`;

   // Para servidor local (localRost)

  //  `INSERT INTO medidas (idMedidas,umidade, temperatura_lm35,hr_medida,fkCanteiro) VALUES (null, ${umidade}, ${temperatura},now(), ${((Math.random()*3)+1).toFixed()})`;
